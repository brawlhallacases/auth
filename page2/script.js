var img = {
  lightblue: '<img src="Color_Esports5.png"/>',
  gold: '<img src="CC-image.png"/>',
  green: '<img src="Color_Charged_OG.png"/>',
  red: '<img src="primepack.png"/>',
...
function reset(){
  $('.card').remove();
  for (var i = 0; i < 210; i++){
    var element = '<div class="card" style="background-color: lightblue;" data-rarity="x5 Esports V1 codes" id=itemNumber'+i+'>'+img.lightblue+'</div>';
    ...
    if (rand > 16 && rand < 18){
      element = '<div class="card" style="background-color: MediumSlateBlue;" data-rarity="Shogun Twitch Prime pack" id=itemNumber'+i+'>'+img.red+'</div>';
    }
    if (rand > 18){
